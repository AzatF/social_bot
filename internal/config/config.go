...
type Config struct {
	...
	DBFilePath      string          `yaml:"db_file_path" env:"DB-FILE-PATH" env-required:"true" env-default:"./model"`
...
type MsgText struct {
	...
	MsgToNewUser           string `yaml:"msg_to_new_user" env:"MSG-TO-NEW-USER" env-required:"true"`
}
